class WeeksController < ApplicationController
  ...
  def create
    ...
    if @week.save
      redirect_to @week, notice: 'Booya! Your article was successfully submitted.'
    else
      render :new
    end
  end
  ...
  private
    ...
    def week_params
      params.require(:week).permit(:start_date, :end_date, :week_number, :user_id)
    end
end
