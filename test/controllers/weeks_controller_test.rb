...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { end_date: @week.end_date, start_date: @week.start_date, week_number: @week.week_number }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { end_date: @week.end_date, start_date: @week.start_date, week_number: @week.week_number }
    assert_redirected_to week_path(assigns(:week))
  end
